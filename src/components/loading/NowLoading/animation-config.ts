import { autoIncrementGenerator, createAnimationConfigs } from '@/hooks/animation/snow';
import { RotationMode, VectorMode } from '@/hooks/animation/snow/types';

const animationConfigs = createAnimationConfigs({
  idGenerator: autoIncrementGenerator,
  configs: [
    /* batch 1 average */
    {
      x: {
